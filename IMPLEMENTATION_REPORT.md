...
✅ **Все высокоприоритетные задачи выполнены и выпущены в релизе v1.1.0**
...
- [x] arc.py
- [x] Сборка без ошибок
- [x] Все тесты пройдены (169/169)
- [x] Релиз v1.1.0 опубликован (24.02.2026)
...
**Скачать:** https://github.com/rybakov25/PostProcessor/releases/tag/v1.1.0
