# -*- coding: ascii -*-
# ============================================================================
# HAAS PARTNO MACRO - Program Start for Haas NGC controllers
# ============================================================================
...
def execute(context, command):
    ...
    # Output Haas-style program header
    context.write("%")  # Program start marker for Haas
    ...
    safety_line = context.globalVars.Get("HAAS_SAFETY_LINE", "G17 G20 G40 G49 G80")
