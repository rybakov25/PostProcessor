# -*- coding: ascii -*-
# ============================================================================
# HAAS INIT MACRO - Initialization for Haas NGC (Next Generation Control)
# ============================================================================

def execute(context, command):
    """
    Initialize all GLOBAL and SYSTEM variables for Haas controllers

    Haas-specific settings:
    - G20/G21 for units
    ...
    context.globalVars.TOOLCHG_LREG = "H"  # Haas uses H for length comp
    ...
    # === Seqno globals ===
    context.globalVars.SEQNO_ON = 0  # Haas typically doesn't use block numbers
    ...
    context.system.CIRCTYPE = 1  # Fanuc/Haas style

    # === Initialize context state ===
    context.currentFeed = None
    context.currentMotionType = "LINEAR"

    # === Setup block numbering (disabled for Haas by default) ===
    context.setBlockNumbering(start=1, increment=0, enabled=False)

    # === Haas-specific safety line ===
    context.globalVars.HAAS_SAFETY_LINE = "G17 G20 G40 G49 G80"

    # === Haas high-speed machining ===
    context.globalVars.HAAS_HSM_ENABLED = 0  # G5.1 Q1 for high-speed machining
